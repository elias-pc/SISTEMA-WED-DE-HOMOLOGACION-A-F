...
// Cambia únicamente estas rutas cuando estén listas las nuevas fotografías.
const corporateImages = {
  logo: 'https://ayf.pe/wp-content/uploads/2020/03/favicom-3.png',
  hero: 'https://ayf.pe/wp-content/uploads/2020/07/Banner-principal-1.webp',
  nosotros: 'https://ayf.pe/wp-content/uploads/2020/07/nosotros.webp',
  homologacion: 'https://ayf.pe/wp-content/uploads/2020/07/homologación-de-empresas_sevicio.webp',
  sistemas: 'https://ayf.pe/wp-content/uploads/2020/07/sistemas-de-gestión.webp',
  planes: 'https://ayf.pe/wp-content/uploads/2020/07/Desarrollo-de-planes-de-negocio.webp',
  proveedores: 'https://ayf.pe/wp-content/uploads/2020/07/bolsa-de-proveedores.webp',
};

const services = [
  {
    title: 'Homologación de Empresas',
    image: corporateImages.homologacion,
  ...
  },
  {
    ...
    image: corporateImages.sistemas,
  ...
  },
  {
    ...
    image: corporateImages.proveedores,
    ...
    <div className="corporate-site">
      <header className="corporate-header">
        <a className="corporate-logo" href="#inicio" aria-label="A&F Servicios Empresariales">
          <img src={corporateImages.logo} alt="A&F Servicios Empresariales" />
        </a>
      ...
      <main>
        <section className="corporate-hero" id="inicio" style={{ '--hero-image': `url("${corporateImages.hero}")` } as CSSProperties}>
          <div className="hero-overlay" />
          <div className="animated-orb orb-one" aria-hidden="true" />
          <div className="animated-orb orb-two" aria-hidden="true" />
        ...
        <section className="corporate-section corporate-wrap" id="nosotros">
          ...
          <div className="corporate-image"><img src={corporateImages.nosotros} alt="Equipo profesional de A&F" /></div>
        </section>
      ...
      <footer className="corporate-footer"><div className="corporate-wrap"><img src={corporateImages.logo} alt="A&F" /><p>Copyright 2026 © A&F Servicios Empresariales S.A.C.</p><Link to="/login">Ingresar al sistema</Link></div></footer>
    </div>
  );
}
