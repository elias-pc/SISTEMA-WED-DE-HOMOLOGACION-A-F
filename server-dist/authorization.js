import { availableTransitions } from './workflow.js';
...
export function canAccessCompany(role, companyIds, companyId) { return role === 'supervisor_general' || role === 'administradora' || companyIds.includes(companyId); }
export function canApplyTransition(role, state, transitionCode) {
